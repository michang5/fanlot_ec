...
define('EMAIL_ADMIN_SUBJECT', 'Feedback letter from contacts form on Yokko');
define('EMAIL_CLIENT_SUBJECT', 'Feedback letter from Yokko');
...
<div id="preloader">
    ...
    Hi, {$name}! <br/>
    You was sent message to administrators Yokko at {$datetime}.<br/><br/>
